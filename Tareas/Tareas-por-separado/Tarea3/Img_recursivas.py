...
def recursive_image_generation(reference_image, filler_image, tile_width, tile_height):    
    ...
    if reference_image and filler_image:
        ...
        with open('CSV/WebPalette.csv', 'r') as csv_file_palette:  # Se lee el archivo CSV con la paleta de colores
...
if __name__ == "__main__":    
    # Ejemplo uno: cat
    reference_image = Image.open('img-a-procesar/cat.png')    # Imagen de referencia 1
    filler_image = Image.open('img-a-procesar/cat.png')       # Imagen de relleno 1
    recursive_image_color = recursive_image_generation(reference_image, filler_image, 15, 15)     # Generamos la imagen recursiva
    recursive_image_color.save('img-resultado/img_recursiva_color_1.png')                                         # Guardamos la imagen
    print("Imagen guardada en img-resultado/img_recursiva_color_1.png")                                            
    
    # Ejemplo dos: girl
    reference_image_2 = Image.open('img-a-procesar/girl.png')    # Imagen de referencia 2
    filler_image_2 = Image.open('img-a-procesar/girl.png')       # Imagen de relleno 2
    recursive_image_color_2 = recursive_image_generation(reference_image_2, filler_image_2, 25, 25)     # Generamos la segunda imagen recursiva
    recursive_image_color_2.save('img-resultado/img_recursiva_color_2.png')    # Guardamos la segunda imagen recursiva
    print("Imagen guardada en img-resultado/img_recursiva_color_2.png")