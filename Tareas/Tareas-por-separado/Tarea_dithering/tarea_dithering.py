...
def random_dithering(reference_image): 
    ...
    result_image.save("random_dithering_result.png")
    return result_image
...
if __name__ == "main":
    ...
    dithering_version(original, 1)
    dithering_version(original, 2)
    dithering_version(original, 3)
    dithering_version(original, 4)
    dithering_version(original, 5)
    dithering_version(original, 6)
    dithering_version(original, 7)
    dithering_version(original, 8)
